...
public class quizschedule
{
	...
	public static void main(String []argv) /* CLI */
	{
		...
		retakes retakesList = new retakes(); /* CLI */
		try
		{
			quizList    =  readQuizzes(courseID);
		...
		if(password.equals("Prof"))
		{
			...
			quizEditor(quizList, retakesList, course);
		}
	...
	//adds the feature of editing the quiz and retake xmls
	public static void quizEditor(quizzes quizList, retakes retakesList, courseBean course)
	{
		Scanner s = new Scanner(System.in);
		
		System.out.println("Type the number of your desired function");
		System.out.println("   1) add a quiz");
		System.out.println("   2) add a retake");
